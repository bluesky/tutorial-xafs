...
Visit https://mybinder.org/v2/gh/bluesky/tutorial-xafs/main?urlpath=lab.
...
2. Clone this project and `cd` into the project root.
   ...
   ```
   git clone https://github.com/bluesky/tutorial-xafs
   cd tutorial-xafs
   ```
...
2. Create a software environment for running and saving changes to the
   ...
   conda create -n tutorial-xafs python=3.8
   conda activate tutorial-xafs
